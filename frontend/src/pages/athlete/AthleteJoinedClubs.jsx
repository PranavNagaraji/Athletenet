...
export default function AthleteJoinedClubs() {
    ...
    <div>
      <div className="page-header">
        <div className="page-header-left">
          ...
          <h1>Joined Clubs</h1>
          <p>View the clubs you have already joined and stay connected to your community.</p>
        </div>
      </div>
      ...
      <div className="page-body stack-lg">
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <p>Browse available clubs and send a request to join the ones that fit your goals.</p>
            <Link to="/athlete/clubs" className="btn-primary" style={{ marginTop: "0.75rem" }}>
              ...
              return (
                <div key={club._id} className="card entity-card" style={{ padding: "1.25rem" }}>
                  ...
                  <p style={{ color: "var(--theme-muted)", lineHeight: 1.7 }}>
                    {club.description || "This club is part of your current network. Use the club page to connect with coaches, teams, and facilities."}
                  </p>
                </div>
              );
            })}
