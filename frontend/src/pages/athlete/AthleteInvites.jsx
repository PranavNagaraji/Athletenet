...
export default function AthleteInvites() {
    ...
    <div>
      <div className="page-header">
        <div className="page-header-left">
          ...
          <p>Accept or reject club invitations sent to your athlete profile.</p>
        </div>
      </div>
      ...
      <div className="page-body">
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <Link to="/athlete/clubs" className="btn-primary" style={{ marginTop: "1rem" }}><Compass size={15} /> Browse Clubs</Link>
          </div>
        ) : (
