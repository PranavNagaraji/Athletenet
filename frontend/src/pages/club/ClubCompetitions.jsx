          ...
          <div className="modal" onClick={e=>e.stopPropagation()}>
            ...
            <div className="form-grid" style={{ gap:"0.9rem" }}>
              <div className="field-group">
                ...
                <input className="field-input" placeholder="e.g. Summer League 2025" value={form.name} onChange={e=>setForm(f=>({...f,name:e.target.value}))}/>
              </div>
              <div className="field-group">
                <label className="field-label">Sport</label>
                <input className="field-input" placeholder="e.g. Football" value={form.sport} onChange={e=>setForm(f=>({...f,sport:e.target.value}))}/>
              </div>
