...
export default function ClubFeed() {
  ...
  return (
    <div style={{ maxWidth: 700, margin: "0 auto", paddingBottom: "3rem" }}>
      ...
      {/* Feed List */}
      {loading ? (
        <div className="loading-state" style={{ marginTop: "4rem" }}><Loader2 size={36} className="spinner-icon" /> <span style={{ color: "var(--c-muted)" }}>Loading global spotlights...</span></div>
      ) : posts.length === 0 ? (
